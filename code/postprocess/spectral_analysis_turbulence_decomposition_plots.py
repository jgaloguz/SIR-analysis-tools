...
window_size = 4
ax1.plot(epoch_time, spsig.savgol_filter(SIR1_bfld_eng_avg, window_size, 0), 'b', linestyle='-')
ax1.plot(epoch_time, spsig.savgol_filter(SIR2_bfld_eng_avg, window_size, 0), 'c', linestyle='-')
ax1.plot(not_epoch_time, not_SIR1_bfld_eng_avg, 'g--')
ax1.plot(not_epoch_time, not_SIR1_bfld_eng_avg+2.0*not_SIR1_bfld_eng_std, 'g:')
ax1.plot(not_epoch_time, not_SIR1_bfld_eng_avg-2.0*not_SIR1_bfld_eng_std, 'g:')
ax1.set_xlabel('Epoch (days)', fontsize=24)
ax1.set_ylabel('Magnetic Energy\nDensity (nT$^2$)', fontsize=24)
...
ax2.plot(epoch_time, spsig.savgol_filter(SIR1_alfv_eng_avg, window_size, 0), 'b', linestyle='-')
ax2.plot(not_epoch_time, not_SIR1_alfv_eng_avg, 'g--')
ax2.plot(not_epoch_time, not_SIR1_alfv_eng_avg+2.0*not_SIR1_alfv_eng_std, 'g:')
ax2.plot(not_epoch_time, not_SIR1_alfv_eng_avg-2.0*not_SIR1_alfv_eng_std, 'g:')
ax2.plot(epoch_time, spsig.savgol_filter(SIR2_alfv_eng_avg, window_size, 0), 'c', linestyle='-')
ax2.plot(epoch_time, spsig.savgol_filter(SIR1_vfld_eng_avg, window_size, 0), 'b', linestyle='--')
ax2.plot(epoch_time, spsig.savgol_filter(SIR2_vfld_eng_avg, window_size, 0), 'c', linestyle='--')
ax2.set_xlabel('Epoch (days)', fontsize=24)
ax2.set_ylabel('Velocity Energy\nDensity (km$^2$/s$^2$)', fontsize=24)
ax2.set_xlim(-4.0, 4.0)
ax2.set_ylim(0.0, 1300.0)
...
ax3.set_xlabel('Epoch (days)', fontsize=24)
ax3.set_ylabel('Compressibility', fontsize=24)
...
ax4.set_xlabel('Epoch (days)', fontsize=24)
ax4.set_ylabel('2D Energy (%)', fontsize=24)
