...
ax1.text(77.0, 0.87, "$r_s$ = {:.2f}".format(1.0 / (1.0 + SIR1_C2_Cs[plot_idx])), color='b', fontsize=16)
ax1.text(77.0, 0.77, "$r_s$ = {:.2f}".format(1.0 / (1.0 + SIR2_C2_Cs[plot_idx])), color='c', fontsize=16)
ax1.axhline(1.0, color='k', linestyle='--')
ax1.set_xlabel('$\\theta_{\\mathrm{BV}}$ ($^\\circ$)', fontsize=24)
ax1.set_ylabel('$P_{yy}/P_{xx}$', fontsize=24)
...
ax2.set_xlabel('$\\theta_{\\mathrm{BV}}$ ($^\\circ$)', fontsize=24)
ax2.set_ylabel('$P_{yy}/P_{xx}$', fontsize=24)
...
ax3.set_xlabel('$\\theta_{\\mathrm{BV}}$ ($^\\circ$)', fontsize=24)
ax3.set_ylabel('$P_{yy}/P_{xx}$', fontsize=24)
...
ax4.set_xlabel('$\\theta_{\\mathrm{BV}}$ ($^\\circ$)', fontsize=24)
ax4.set_ylabel('$P_{yy}/P_{xx}$', fontsize=24)
